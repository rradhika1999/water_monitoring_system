...
void DistanceSensor(int trigPin,int echoPin)
{
...
const char* password = "Nir@1965";
//also uncomment and write here your own adafruit IO username and key.
#define AIO_USERNAME    "srh8"//replace it with your username
#define AIO_KEY         "aio_ovMB54p2reXz5QIdpygXXPWcDMlY"//replace it with your key
...
int waterLevelUpperThreshold=25;
//int waterLevelLowerThreshold1=3;
//int waterLevelUpperThreshold1=25;
...
int waterLevelDownCount1=0,waterLevelUpCount1=0;
...
void handleRangeSetting(){
   ...
   //waterLevelLowerThreshold1=(server.arg(0)).toInt();  
  // waterLevelUpperThreshold1=(server.arg(1)).toInt();
  // Serial.print(waterLevelLowerThreshold1);
  // Serial.print(":");  
   //Serial.println(waterLevelUpperThreshold1);
...
void measure_Volume()
{
    DistanceSensor(trigPin, echoPin);  //D1 trig, D2=echo
    tank = distance;
    float heightInch=0.393701*tank;    
  ...
  //  DistanceSensor(trigPin1, echoPin1);  //D1 trig, D2=echo
   // sump = distance;
    //float heightInch1=0.393701*sump;    
    //Serial.println(heightInch);
   // if(heightInch1>MAX_HEIGHT)
    //  heightInch1=MAX_HEIGHT;
   // if(heightInch1<0)
    //  heightInch1=0;      
  //  volume1=3.14*RADIUS*RADIUS*(MAX_HEIGHT-heightInch1);//MAX_HEIGHT-distance will give actual height,
   // liters1=volume1*0.0164  ;
   // Serial.println(liters1);

    //if(liters<=waterLevelLowerThreshold1)
      //  waterLevelDownCount1++;
     // else waterLevelDownCount1=0;

     // if(liters>=waterLevelUpperThreshold1)
     //   waterLevelUpCount1++;
     // else waterLevelUpCount1=0;

    //  waterLevel.publish(liters1);
